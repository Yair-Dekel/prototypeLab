    ...
    public static void main(String[] args) throws IOException {
        ...
        if (!DB.isDatabaseNotEmpty()) {
            try {
                ...
                Registered_user user4 = new Registered_user("Linoy","Ohaion","linoyOhaion2","1232",true,"0502213188","Tel-Aviv","Tel-Aviv");
                Registered_user user5 = new Registered_user("Roman","Shapira","romanroman","1231",false,"0521153111","Tel-Aviv");
                ...
                Task t1 = new Task(TaskType.BABYSITTING,user1 , futureDeadline1, "in my house loaction: horev 10",now.plusDays(1));
